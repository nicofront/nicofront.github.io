...
var _dummy = _interopRequireDefault(require("./components/dummy.js"));
...
ready(function () {
  console.log('ready!'); // Example of loading a Class
  ...
  $('.tester-switch').click(function (e) {
    var self = $(this);
    var parent = self.parents('.testerparent');
    e.preventDefault();
