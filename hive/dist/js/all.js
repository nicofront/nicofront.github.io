...
$(document).ready(function() {
    ...
    if($('.slider__banners').length > 0){
        $('.slider__banners').slick({
            infinite: false,
            centerPadding: '30px',
            slidesToShow: 2,
            slidesToScroll: 2,
        ...
        $("#form-contacto").validate({
            ...
            submitHandler: function(form) {
                if (grecaptcha.getResponse()) {
                    $("#form-contacto").ajaxSubmit({url: '../mailer-contacto.php', type: 'post'});
                    $('#form-contacto').hide();
                    $("#formulario__success").slideDown();
                    $('html, body').animate({
                        scrollTop: $("#formulario").offset().top
                    }, 500);
                    console.log('Correo');
                } else {
                    alert('Confirma el captcha para continuar');
                }
            }
        });
    }
    ...
    if($('#form-demo').length > 0){
        ...
        $("#form-demo").validate({
            ...
            submitHandler: function(form) {
                if (grecaptcha.getResponse()) {
                    $("#form-demo").ajaxSubmit({url: '../mailer-demo.php', type: 'post'});
                    $('#form-demo').hide();
                    $('#stepper').hide();
                    $("#formulario__success").slideDown();
                    $('html, body').animate({
